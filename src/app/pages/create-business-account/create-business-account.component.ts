...
@Component({
  ...
  styleUrl: './create-business-account.component.scss'
})
export class CreateBusinessAccountComponent {
      ...
      this.userService.genOtpPages(otpObj).subscribe(
        res => {
          if (res['error'] == 0) {
            ...
            this.showDiv.createBusinessAccountDiv = false;
        ...
        error => {
          ...
          this.showDiv.createBusinessAccountDiv = true;
  ...
  otpverify() {
    ...
    if (this.userOtp) {
      ...
      this.userService.sendCreateBusinessAccountMail(data).subscribe({
        next: (res) => {
          this.stopOtpTimer();

          this.contactForm.reset();
          this.submitted = false;
          console.log('Response from sendCreateBusinessAccountMail:', res);
          this.toaster.success('Create Business Account mail sent successfully');
          this.otpValid = true;
          this.isValid = true;
